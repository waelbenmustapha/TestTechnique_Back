...
class TestTechniqueBackApplicationTests {
	...
	void TestAjoutPerson()
	{
		...
		Person person1=new Person(99L,"test","testprenom","M",new Date(),"test",2,"unittestuser","hi","ok","nice","good","test","data","is it","good","work","finally","last","comment");
		//create person 2 with some empty fields
		Person person2=new Person(100L,"test2","testprenom","Mme",new Date(),null,0,"unittest2","hi",null,"nice",null,"test","data","is it",null,"work","finally","last",null);
